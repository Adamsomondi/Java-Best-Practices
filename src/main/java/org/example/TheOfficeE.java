...
public class TheOfficeE {
    ...
    public TheOfficeE(List<Integer> employees, List<Double> Mbudget) {
        this.numEmployees = new ArrayList<>();
        this.budget = new ArrayList<>();
    ...
    public void setBudget(List<Double> Mbudget) {
        this.budget = new ArrayList<>(Mbudget);
    }
    ...
    public TheOfficeE(TheOfficeE other) {
    ...
    public static void main(String[] args) {
        ...
        TheOfficeE VanceRefrigeration = new TheOfficeE();
        ...
        TheOfficeE DunderMifflin = new TheOfficeE(scranton_employees, scranton_budgets);
        ...
        TheOfficeE StamfordBranch = new TheOfficeE(DunderMifflin); // Copy constructor called
        ...
        System.out.println("First department employees: " + updated_vance_employees.get(0));
        System.out.println("Last department employees: " + updated_vance_employees.get(updated_vance_employees.size() - 1));
        ...
        System.out.println("\nTotal offices created so far: " + TheOfficeE
                .getOfficeCount());
    }
}
